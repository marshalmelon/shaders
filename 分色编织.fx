...
float3 getSameColor(const float3 color, const float2 uv, const float2 xy, int3 flag) {
    float3 scan0 = float3(flag.x == 0, flag.x == 1, flag.x == 2);
    float3 scan2 = float3(flag.z == 0, flag.z == 1, flag.z == 2);
